...
# Type: New Service
#
# Title: M365 - Remove Teams Team
#
# v 1.0 Initial Release
# v 1.1 Added Stored Credentials
#       see for details: https://au2mator.com/documentation/powershell-credentials/?utm_source=github&utm_medium=social&utm_campaign=M365_RemoveTeamsTeam&utm_content=PS1
# v 1.1 Added SMTP Port
# v 1.2 applied v1.3 Template, code designs, Powershell 7 ready, au2mator 4.0, GRAPH API
#
# Init Release: 18.05.2020
# Last Update: 29.12.2020
# Code Template V 1.3
#
# URL: https://au2mator.com/remove-a-microsoft-teams-team-microsoft-teams-self-service-with-au2mator/?utm_source=github&utm_medium=social&utm_campaign=M365_RemoveTeamsTeam&utm_content=PS1
# Github: https://github.com/au2mator/TEAMS-Remove-a-Team-from-Microsoft-Teams
#################
...
[string]$LogPath = "C:\_SCOworkingDir\TFS\PS-Services\M365 - Remove Teams Team"
[string]$LogfileName = "Remove Teams Team"
...
try {
    ...
    Write-au2matorLog -Type INFO -Text "Connected to Graph API"

    try {
        Write-au2matorLog -Type INFO -Text "Try to remove the Team"

        $URLRemove="https://graph.microsoft.com/v1.0/groups/$c_TeamID"

        Invoke-RestMethod -Headers $headers -Uri $URLRemove -Method DELETE

        Write-au2matorLog -Type INFO -Text "The Team was removed"

        $au2matorReturn = "Teams was removed"
        $AdditionalHTML = "Teams was removed
        <br>
        Error: $Error
            "
        $Status = "COMPLETED"
        ...
        Write-au2matorLog -Type ERROR -Text "Could not remove the Team"
        Write-au2matorLog -Type ERROR -Text "Error: $Error"

        $au2matorReturn = "Could not remove the Team, Error: $Error"
        $AdditionalHTML = "Could not remove the Team
        <br>
        Error: $Error
            "
        $Status = "ERROR"
    ...
    Write-au2matorLog -Type ERROR -Text "Error on connecting to Microsoft Teams: $Error"

        $au2matorReturn = "Error on connecting to Microsoft Teams, Error: $Error"
        $AdditionalHTML = "Error on connecting to Microsoft Teams
        <br>
        Error: $Error
            "
        $Status = "ERROR"
